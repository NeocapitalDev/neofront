...
import { HomeIcon,UserCircleIcon, CreditCardIcon, ChatBubbleLeftEllipsisIcon, LifebuoyIcon, ArrowRightOnRectangleIcon, CheckBadgeIcon } from '@heroicons/react/24/outline';
