...
export default function ChallengeRelations() {
  ...
  return (
    <>
      {/* Encabezado minimal con las imágenes (versión móvil y escritorio) */}
      <nav className="bg-black dark:bg-zinc-800 shadow-sm border-b border-zinc-700">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 dark:text-white">
          <div className="flex h-16 items-center">
            {/* LOGO: versión móvil y escritorio */}
      ...
      {/* Contenido principal con el fondo degradado y tarjetas */}
